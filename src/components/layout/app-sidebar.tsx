...
const PAGE_META: Record<AppPage, { label: string; icon: string; section: 'main' | 'admin' }> = {
  ...
  'agent-dashboard': { label: 'Mon Espace Agent', icon: 'LayoutDashboard', section: 'main' },
  'chef-service-dashboard': { label: 'Mon Espace Chef Service', icon: 'LayoutDashboard', section: 'main' },
  'ministre-dashboard': { label: 'Cabinet Ministériel', icon: 'LayoutDashboard', section: 'main' },
